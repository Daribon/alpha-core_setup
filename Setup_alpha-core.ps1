...
mariadb --user=$username --password=$password --port=$port -e "drop database $realm";
mariadb --user=$username --password=$password --port=$port -e "drop database $dbc";
mariadb --user=$username --password=$password --port=$port -e "drop database $world";
